        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              I'm a passionate web developer with a keen eye for detail and a commitment to creating 
              exceptional digital experiences. With expertise in modern web technologies, I transform 
              ideas into powerful, user-friendly applications that drive results.
            </p>
            
            <p className="text-gray-300 leading-relaxed">
              My journey in web development has equipped me with a strong foundation in both frontend 
              and backend technologies. I thrive on challenges and continuously seek opportunities to 
              learn and grow in this ever-evolving field.
            </p>
            
            <div className="grid grid-cols-2 gap-4 pt-4">
              <div className="bg-gray-900 p-4 rounded-lg">
                <h4 className="font-semibold text-[#016bdb] mb-2">Experience</h4>
